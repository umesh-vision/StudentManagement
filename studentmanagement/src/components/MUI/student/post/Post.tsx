...
import CommentButton from '../../../pages/student/studentpost/CommentButton';
import LikeButton from '../../../pages/student/studentpost/LikeButton';
import ViewComment from '../../../pages/student/studentpost/ViewComment';
import { DeleteModel } from '../../../pages/student/common/DeleteModel';
import AddCommentArea from '../../../pages/student/studentpost/AddCommentArea';
          ...
          <div className='col-md-8'>
            {
              ...
              <div>
                <Card className="mt-2" key={index}>                  
                  ...
                  <CardContent style={{backgroundColor:"#a7a7a7"}}>               
                    <div className='row'>
