...
export default class ViewComment extends Component<Props, IState> {    
    ...
    onEdit=async()=>{
        const {index,postId,commentIndex,commentId,commentList}=this.state
        this.props.onEditComment(postId,commentId,index,commentIndex,commentList.comment);
    }
        ...
        <div  className={"row " +(loggedUser===userId?'justify-content-end':'')}>           
            <div className='col-md-10' >   
                <div className="card text-bg-light mt-2 ">   
                    <div className="card-header" style={{backgroundColor:"#dee2e6"}}>
                        <div className="row">
                            <div className='col-md-10'>
