...
export default class CommentButton extends Component<Props, IState> {
            ...
            <>       
             <Tooltip title="Comment">
                ...
                >
                    ...
                    <SmsOutlinedIcon width="25px" height="20px" />
                    ...
                    <strong style={{marginLeft:"3px"}}>| {totalComment}</strong>    
                </Button>
             </Tooltip>
            </>
        )
